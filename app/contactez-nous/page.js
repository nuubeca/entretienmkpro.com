...
export const metadata = {
  title: "Contactez-nous - Entretien MK Pro",
  description: "Contactez Entretien MK Pro pour obtenir une soumission gratuite pour vos besoins d'entretien ménager à Sherbrooke.",
};
        ...
        <div className="hero">
          <div className="hero-content flex-col lg:flex-row-reverse w-full">
            ...
            <div className="pb-5 lg:w-6/12 lg:pr-5">
              ...
              <ContactFormClient action={sendContactForm} />
            </div>
          </div>
        </div>
      </div>
